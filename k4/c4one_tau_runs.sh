...
# least omega; -i15/-i17 least omega with tie-breaks; -i18/-i19 the exchange lemma X of k4/c4one.md §6 from every sequence, -i20 lemma X'.
cd "$(dirname "$0")/.."
...
for o in "-P -i2" "-P -Q -i2" "-P2 -i2" "-P2 -Q -i2" "-P2 -Q2 -i2" "-P2 -i0" "-P2 -Q -i0" "-P2 -Q2 -i0" \
         ...
         "-P2 -i15" "-P2 -i17" "-P -i17" "-P2 -i18" "-P2 -i19" "-P -i19" "-P2 -i20" "-P -i20"; do
