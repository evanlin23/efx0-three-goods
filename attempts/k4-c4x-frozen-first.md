...
- (−frozen, leximin), (−frozen, slots, leximin), (−frozen, −exposed), (−frozen, frozen agents' Σℓ), and 15 more
  lexicographic combinations: every-form fails at n = 3 (`k4/c4x.md` §5 table).
...
3. (−frozen, Σℓ), every-form, **n = 3, m = 6** (smallest m at n = 3; exhaustive): agents 0: goods 0, 2, 4, 5 with values
   2, 3, 4, 8 (a > b + c); 1: goods 1, 3, 5 with values 2, 4, 3; 2: goods 3, 4, 5 with values 4, 2, 3.
4. (−frozen, Σℓ), some-form (no maximum completable), **n = 3, m = 8** (smallest m at n = 3; exhaustive): the pure
