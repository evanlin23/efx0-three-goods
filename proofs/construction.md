...
**Open.**
1. S2.LB: LB never fails. Theorem 1 reduces this to the existence of an owner in the last step. Certified for every core with n ≤ 6 (S2.N6), every connected core with n = 7 (S2.N7), and every connected core with n = 8, m ≥ 13 (S2.N8).
